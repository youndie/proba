                ...
                listOf(
                    RowComponent(
                        ...
                        children =
                            listOf(
                                badge(id, look),
                                TextComponent(id = "$id-check", text = finding.checkId, style = Type.Code),
                            ),
                    ),
    ...
    private fun badge(
        ...
        RowComponent(
            ...
            children =
                listOf(
                    mark("$id-mark", look),
                    TextComponent(id = "$id-word", text = look.word, style = Type.Label),
                ),
        )
        ...
        return when (look.shape) {
            "solid" -> {
                ColumnComponent(
                    id = id,
                    children = emptyList(),
                    modifiers = listOf(box, KompotModifierNode.Background(look.color)),
                )
            }
            ...
            "half" -> {
                ...
                ColumnComponent(
                    ...
                    modifiers =
                        listOf(
                            box,
                            KompotModifierNode.Background(look.color),
                            KompotModifierNode.Padding(all = RING),
                        ),
                    children =
                        listOf(
                            ColumnComponent(
            ...
            children =
                listOf(
                    ...
                    ButtonComponent(
                        ...
                        action =
                            OpenUrlAction(
                                "https://central.sonatype.com/artifact/${coordinate.group}/${coordinate.artifact}",
                            ),
                    ),
                ),
        )

    private fun look(severity: Severity): SeverityLook =
        when (severity) {
